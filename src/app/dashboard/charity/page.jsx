      ...
      <main className="flex-1 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div>
            ...
            <h1 className="text-3xl font-extrabold text-slate-900">Charity Preferences</h1>
            <p className="text-sm text-slate-500 mt-1">
              Select your preferred charity and configure your contribution percentage (minimum 10% required).
            </p>
          </div>
