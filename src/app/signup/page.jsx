...
function SignupContent({ initialCharities = [] }) {
  return (
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <Suspense fallback={<div className="text-slate-500">Loading registration...</div>}>
          <SignupContent initialCharities={charities} />
        </Suspense>
      </main>
      <Footer />
    </div>
